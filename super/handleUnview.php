...
if(isset($_POST['id']) && isset($_POST['visibility']) && isset($_SESSION['username'])){
    $id = $_POST['id'];
    ...
    $sql  = "UPDATE notices SET visibility='$visib' where id = '$id'";
    if ($conn->query($sql) === TRUE) {
        echo '<div style="margin-top:10px" class="alert alert-success alert-dismissible">
        <button type="button" class="close" data-dismiss="alert">&times;</button>
        <strong>Success!</strong> The Notice has been modified!
        </div>';
    } else {
